import {ideal} from '../../../src/client/common/ScaleText'
...
it.each`
  ...
  ${['beam post commit java validates runner dataflow']}                                                     | ${100} | ${652} | ${24}
  ${['dir kerby openjdk 2h', 'beam release nightly snapshot 3h']}                                            | ${761} | ${652} | ${88}
  ${['dir kerby openjdk 2h', 'beam release nightly snapshot 3h', 'pre commit zookeeper github pr build 3h']} | ${616} | ${630} | ${71}
