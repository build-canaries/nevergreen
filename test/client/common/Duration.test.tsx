...
describe('<Duration/>', () => {
  ...
  describe('abbreviated', () => {
    ...
    test('should display an abbreviated duration that is hidden from screen readers', () => {
    ...
    test('should include a visually hidden full description for screen readers', () => {
      setSystemTime('2018-02-18T23:38:00Z')
      const props = {...DEFAULT_PROPS, abbreviate: true, timestamp: '2000-12-01T00:00:00Z'}
      const wrapper = shallow(<Duration {...props} />)
