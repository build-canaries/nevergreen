...
import {enableSystemNotifications} from '../../../src/client/settings/SettingsThunkActionCreators'
import * as settingsActionCreators from '../../../src/client/settings/SettingsActionCreators'
