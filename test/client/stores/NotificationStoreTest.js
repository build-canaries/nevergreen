...
import {AppInit, Notification, NotificationDismiss} from '../../../src/client/NevergreenActions'
...
describe('notification store', () => {
  ...
  before(() => {
    ...
    subject = proxyquire('../../../src/client/stores/NotificationStore', {'../common/AppDispatcher': AppDispatcher})
