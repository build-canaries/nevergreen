...
import {MESSAGE_ADD, MESSAGE_REMOVE} from '../../../src/client/success/SuccessActions'
...
describe('success store', () => {
  ...
  before(() => {
    ...
    subject = proxyquire('../../../src/client/stores/SuccessStore', {'../common/AppDispatcher': AppDispatcher})
