...
import {TrayAdd, ProjectsFetched} from '../../../src/client/tracking/TrackingActions'
...
describe('fetched projects store', () => {
  ...
  before(() => {
    ...
    subject = proxyquire('../../../src/client/stores/FetchedProjectsStore', {'../common/AppDispatcher': AppDispatcher})
