            ...
            return (
                <p className='tracking-cctray-group-build-item'>
                    <label className={labelClass}>
                        <input ref='toggleIncluded' className='checkbox no-text-selection' type='checkbox' checked={this.props.included} onChange={this.onChange} disabled={this.props.wasRemoved}/>
