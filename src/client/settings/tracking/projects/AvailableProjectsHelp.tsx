      ...
      <HelpForm>
        <HelpInput name="Tracking mode">
          <dl>
            <dt>Everything</dt>
            <dd>
              All projects returned by the feed will be tracked.
            </dd>
            <dt>Selected</dt>
            <dd>
              This allows projects to be selected manually for tracking.
            </dd>
          </dl>
        </HelpInput>
        <p>The following options are only available if Tracking mode is <em>Selected</em>.</p>
