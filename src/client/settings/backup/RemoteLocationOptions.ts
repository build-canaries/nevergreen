...
export function isCustomServer(location?: RemoteLocation): location is RemoteLocation {
  return location?.where === RemoteLocationOptions.Custom
}

export function isGitHub(location?: RemoteLocation): location is RemoteLocation {
