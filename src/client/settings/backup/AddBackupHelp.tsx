    ...
    <HelpArticle keywords={[...KEYWORDS, 'custom server']}
      ...
      <HelpForm>
        <HelpInput name='URL'>
          ...
          need to support multiple exports with the same custom server, you can make it RESTful and specify the ID
          directly.
        </HelpInput>
      </HelpForm>
    </HelpArticle>
  ...
  return (
    <HelpArticle keywords={[...KEYWORDS, 'access token', 'gitlab', 'snippet']}
      ...
      <HelpForm>
        ...
        <HelpInput name='ID'>
          Add a snippet <strong>ID</strong> to update an existing Snippet or leave blank to create a new Snippet. You
          can get a Snippet ID from the Snippet URL, <URL url='https://gitlab.com/snippets/:snippetId'/>.
        </HelpInput>
        <HelpInput name='Access token'>
          You need to <ExternalLink
