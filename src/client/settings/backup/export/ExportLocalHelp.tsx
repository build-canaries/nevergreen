    ...
    <HelpArticle keywords={keywords}
      ...
      <HelpForm>
        <HelpInput name='Save locally...'>
          ...
          is <code>nevergreen-configuration-backup-{timestamp}.json</code>, where <code>{timestamp}</code> is the
        ...
        <HelpInput name='Current configuration'>
          This is the current configuration that can be exported. This is a readonly text area so the configuration
          can be easily manually copied.
        </HelpInput>
