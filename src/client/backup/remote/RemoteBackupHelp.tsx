...
export function RemoteBackupHelp({searchQuery}: HelpProps): ReactElement {
  return (
    <HelpArticle keywords={KEYWORDS}
                 ...
                 page='/backup'>
      <p>
        You can import and export to multiple remote backup locations. Use <strong>Add location</strong> to add a new
