...
const developerToolsLink = 'https://developer.mozilla.org/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools#Find_out_more_2'
...
export function UnhandledErrorMessage(): ReactElement {
  return (
    <div className={styles.content}>
      ...
      <p>
        Your <ExternalLink href={developerToolsLink}>browser developer tools</ExternalLink> may provide more
        information about the error. If so, you can <ExternalLink href={issueLink}>report bugs to us on
        GitHub</ExternalLink>.
      </p>
      <p>
