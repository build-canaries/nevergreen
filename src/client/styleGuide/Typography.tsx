...
import {ErrorMessages, InfoMessages, SuccessMessages, WarningMessages} from '../common/Messages'
import {LinkButton} from '../common/LinkButton'
import {FloppyDisk} from '../common/icons/FloppyDisk'
import {TimedErrorMessages, TimedInfoMessages, TimedSuccessMessages} from '../common/TimedMessages'
  ...
  return (
    <>
      ...
      <StyleGuideSection title="Messages">
        ...
        <InfoMessages messages={['info messages', ...MESSAGES]} onDismiss={() => alert('Dismissed')}/>
        ...
        <SuccessMessages messages={['success messages', ...MESSAGES]} onDismiss={() => alert('Dismissed')}/>
        ...
        <ErrorMessages messages={['error messages', ...MESSAGES]} onDismiss={() => alert('Dismissed')}/>
        ...
        <WarningMessages messages={['warning messages', ...MESSAGES]} onDismiss={() => alert('Dismissed')}/>
      ...
      <StyleGuideSection title="Timed messages">
        <TimedInfoMessages onDismiss={noop}
                           messages="Chocolate bar tart jelly-o ice cream jelly pastry pastry candy pudding"/>
        <TimedSuccessMessages onDismiss={noop}
                              messages="Chocolate bar tart jelly-o ice cream jelly pastry pastry candy pudding"/>
        <TimedErrorMessages onDismiss={noop}
                            messages="Chocolate bar tart jelly-o ice cream jelly pastry pastry candy pudding"/>
      </StyleGuideSection>
    </>
  )
