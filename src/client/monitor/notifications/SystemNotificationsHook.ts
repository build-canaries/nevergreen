...
import {getAllowSystemNotifications, getNotifications} from '../../settings/notifications/NotificationsReducer'
...
export function useSystemNotifications(projects: Projects, feedErrors: FeedErrors): void {
