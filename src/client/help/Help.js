    ...
    return (
      <Fragment>
        ...
        <Container title='Success' className={styles.container}>
          ...
          <p>Try searching for some <ExternalLink href='https://duckduckgo.com/?q=nature+1920x1080&iax=1&ia=images'>nice images</ExternalLink> or checkout <ExternalLink href='http://www.disapprovallook.com/'>Disapproval Look</ExternalLink> for some fun messages, like jelly guy! <span style={{ whiteSpace: 'nowrap' }}>༼ つ◕_◕ ༽つ</span></p>
        </Container>
